...
## Making API requests
Because the selected-tests service is hosted in Kanopy, authentication is done
through CorpSecure. To make requests to the selected-tests API you will need to
include your CorpSecure auth_user and auth_token cookies in your request.
